...
public class CurrencyConverterView extends Application {
    ...
    public void start(Stage stage) throws Exception {
        this.xml = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/CurrencyConverterView.fxml")));
        stage.setTitle("Currency Converter");
        stage.setScene(new Scene(this.xml));
        stage.show();

        CurrencyConverterController controller = CurrencyConverterController.getInstance();
